...
cd /usr/bin
wget https://raw.githubusercontent.com/robbyhalintar2/cxr/main/limit/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
cd /root
wget https://raw.githubusercontent.com/robbyhalintar2/cxr/main/limit/regis.zip
unzip regis.zip
rm -rf regis.zip
...
echo -e "${grenbo}[*] Bot By CX STORE${NC}"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
